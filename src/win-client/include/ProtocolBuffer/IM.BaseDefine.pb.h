...
const LoginCmdID LoginCmdID_MIN = CID_LOGIN_CMD_UNKNOWN;
...
const BuddyListCmdID BuddyListCmdID_MIN = CID_BUDDY_LIST_CMD_UNKNOWN;
...
const MessageCmdID MessageCmdID_MIN = CID_MSG_CMD_UNKNOWN;
...
const GroupCmdID GroupCmdID_MIN = CID_GROUP_CMD_UNKNOWN;
...
const FileCmdID FileCmdID_MIN = CID_FILE_CMD_UNKNOWN;
...
const SwitchServiceCmdID SwitchServiceCmdID_MIN = CID_SWITCH_CMD_UNKNOWN;
...
const OtherCmdID OtherCmdID_MIN = CID_OTHER_CMD_UNKNOWN;
...
const GroupType GroupType_MIN = GROUP_TYPE_TMP;
const GroupType GroupType_MAX = GROUP_TYPE_NORMAL;
