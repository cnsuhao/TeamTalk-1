...
namespace IM {
namespace Other {
class IMHeartBeatDefaultTypeInternal : public ::google::protobuf::internal::ExplicitlyConstructed<IMHeartBeat> {
...
void TableStruct::Shutdown() {
  _IMHeartBeat_default_instance_.Shutdown();
}
...
void TableStruct::InitDefaultsImpl() {
  ...
  _IMHeartBeat_default_instance_.DefaultConstruct();
}
...
IMHeartBeat::IMHeartBeat()
  ...
  if (GOOGLE_PREDICT_TRUE(this != internal_default_instance())) {
    protobuf_IM_2eOther_2eproto::InitDefaults();
  }
  SharedCtor();
